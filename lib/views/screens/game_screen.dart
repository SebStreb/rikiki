  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Provider.of<GameViewModel>(context, listen: false).activeRound = null;
        ...
        actions: [
          IconButton(
            onPressed: () => showDialog(context: context, builder: (context) => const PointsDialog()),
            icon: const Icon(Icons.scoreboard),
          ),
          IconButton(
            onPressed: () => showDialog(context: context, builder: (context) => const PlayersDialog()),
            icon: const Icon(Icons.people),
          ),
          IconButton(
            onPressed: () => showDialog(context: context, builder: (context) => const ConfigDialog()),
      ...
      body: Padding(
        ...
        child: Consumer<GameViewModel>(
          builder: (context, viewModel, child) =>
              viewModel.step == Steps.bet ? const BetsComponent() : const TricksComponent(),
        ),
      ),
    );
  }
